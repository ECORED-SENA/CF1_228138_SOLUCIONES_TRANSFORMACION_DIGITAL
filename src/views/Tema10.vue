...
.curso-main-container.pb-3.tema10
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5    
    ...
    .row.justify-content-center.align-items-center.mb-0(data-aos="fade-right")      
      .col-lg-7.col-12
        h4.mb-5 Un hacker ético es una persona que realiza pruebas de penetración con la intención de buscar y encontrar vulnerabilidades actuando de forma igual, o al menos similar, y utilizando los mismos métodos que usaría un hacker con intención de atacar el sistema.
        .cajon.color-secundario.p-4.mb-lg-0.mb-3
          p.mb-0  Las pruebas de penetración de un hacker ético, permiten evaluar vulnerabilidades, analizar y categorizar las debilidades explotadas y proveer recomendaciones, con base a las prioridades de la organización y por último eliminar dichas vulnerabilidades.
      .col-lg-5.col-8
        img.mb-0(src="@/assets/curso/tema10/img01.png")

    Separador
    #t_10_1.titulo-segundo.color-acento-contenido
      h2 10.1 Objetivos del ethical hacking
      ...
      .bloque-texto-b.color-secundario.p-4.mb-0(data-aos="fade-left")
        .bloque-texto-b__texto        
          .row.justify-content-center.align-items-center.d-flex
            ...
            .col-lg-10.col-12
                p.mb-0 El objetivo fundamental del ethical hacking es explorar las vulnerabilidades existentes en los sistemas, haciendo pruebas de intrusión, que sirven para verificar y evaluar la seguridad física y lógica de los sistemas de información, redes de computadoras, aplicaciones web, bases de datos, servidores, etc.<br><br><b>Esta técnica logra el acceso y demuestra si un sistema es vulnerable o no. Esta información sirve para tomar medidas preventivas en contra de ataques.</b>

    Separador
    #t_10_2.titulo-segundo.color-acento-contenido
      h2 10.2 Tipos de pruebas de penetración

    p.mb-5 <b>Dentro del ejercicio del ethical hacking, existen tres tipos de pruebas de penetración: caja negra, caja blanca y caja gris</b>. Descubra las particularidades de cada una de estos tres tipos de pruebas de penetración.
